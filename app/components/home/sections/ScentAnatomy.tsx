  ...
  return (
    <div className="h-full w-full bg-inkwell-800 p-3 sm:p-4">
      ...
      >
        ...
        <motion.div
          className="flex flex-none items-center justify-between px-6 py-6 sm:px-8"
          variants={fadeUpItem}
        >
        ...
        >
          ...
          <div className="pl-4 sm:pl-6">
            <h3 className="font-['wayfinder-cf'] text-[clamp(2rem,3.75vw,2.75rem)] font-light leading-[1.05] tracking-[-6%]">
              Kids on the Slope
            </h3>
