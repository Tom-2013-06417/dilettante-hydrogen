...
export function CollectionHeader({
  ...
  return (
    <header className="flex flex-col items-center py-7 text-center text-inkwell-700 sm:py-14">
      {launchDateLabel ? (
        <span className="m-0 font-['config-mono-vf'] text-[9px] font-light uppercase tracking-[0.4em] text-inkwell-700/45 lg:text-[13px]">
          {launchDateLabel}
        </span>
      ) : null}
      <span
        className={`relative m-0 inline-block font-['config-mono-vf'] text-[16px] font-medium uppercase leading-tight tracking-[0.06em] sm:text-[1.5rem] lg:text-[2.16rem] ${
      ...
      {tagline ? (
        <span className="m-0 mt-1 font-['config-mono-vf'] text-[11px] font-light tracking-[0.01em] text-inkwell-700/85 sm:text-[15px] lg:text-[22px]">
          {tagline}
        </span>
      ) : null}
    </header>
